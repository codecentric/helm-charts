...
| `extraInitContainers`                         | Additional init containers, e. g. for providing custom themes. Accepts either a `tpl`-rendered string (backwards compatible) or a structured YAML list.                                                                                                                            | `[]`                                                                                                                                                                                    |
...
| `extraContainers`                             | Additional sidecar containers, e. g. for a database proxy, such as Google's cloudsql-proxy. Accepts either a `tpl`-rendered string (backwards compatible) or a structured YAML list.                                                                                              | `[]`                                                                                                                                                                                    |
...
| `extraEnv`                                    | Additional environment variables for Keycloak. Accepts either a `tpl`-rendered string (backwards compatible) or a structured YAML list.                                                                                                                                            | `""`                                                                                                                                                                                    |
| `extraEnvFrom`                                | Additional environment variables for Keycloak mapped from a Secret or ConfigMap. Accepts either a `tpl`-rendered string (backwards compatible) or a structured YAML list.                                                                                                          | `""`                                                                                                                                                                                    |
...
| `extraVolumes`                                | Add additional volumes, e. g. for custom themes. Accepts either a `tpl`-rendered string (backwards compatible) or a structured YAML list.                                                                                                                                          | `""`                                                                                                                                                                                    |
| `volumeClaimTemplates`                        | Add volume claim templates to the StatefulSet, e. g. for dynamic provisioning                                                                                                                                                                                                     | `""`                                                                                                                                                                                    |
| `extraVolumeMounts`                           | Add additional volumes mounts, e. g. for custom themes. Accepts either a `tpl`-rendered string (backwards compatible) or a structured YAML list.                                                                                                                                   | `""`                                                                                                                                                                                    |
